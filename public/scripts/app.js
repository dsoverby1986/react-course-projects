...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function componentDidUpdate() {
            ...
            console.log(this.state, this.props, this.prevProps, this.prevState);
        }
    }, {
        ...
        value: function handleDeleteOption(option) {
            this.setState(function (prevState) {
                var options = prevState.options.filter(function (o) {
                    return o !== option;
                });
        ...
        value: function handlePick() {
            ...
            var decision = this.state.options[randomNum];
            alert(decision);
        }
    }, {
        key: 'handleAddOption',
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'li',
                    { className: 'tall-list-item max-width-500' },
                    React.createElement(
                        'div',
                        { className: 'col-xs-10' },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { className: 'pull-right btn btn-danger', onClick: this.handleDeleteOption },
                            'Remove'
                        )
                    )
                )
...
var AddOption = function (_React$Component3) {
    ...
    _createClass(AddOption, [{
        ...
        value: function handleAddOption(e) {
            ...
            var optionVal = option.value.trim();
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('input', { type: 'text', className: 'form-control', name: 'option', placeholder: 'Add option' }),
                        React.createElement(
                            'span',
